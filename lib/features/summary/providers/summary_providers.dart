...
import '../../notes/providers/notes_providers.dart' show notesRepositoryProvider;
...
final weeklySummaryProvider =
    FutureProvider.autoDispose<WeeklySummaryEntity>((ref) async {
  return ref.watch(summaryRepositoryProvider).getWeeklySummary();
});